...
public:
  ...
  // BC Dirichlet condition.
  class FunctionBoundary : public Function<dim>
  {
  public:
    FunctionBoundary() = default;
    virtual double value(const Point<dim> &p, const unsigned int component = 0) const override
    {
      (void)component;
      return sin(3.0 * M_PI * p[0]) + sin(2.0 * M_PI * p[1]);
    }
  };

  // BC Neumann condition.
  class FunctionBoundaryNeumann : public Function<dim>
  {
  public:
    FunctionBoundaryNeumann() 
    {};
    virtual double
