...
void
DiffusionReactionmine::assemble()
{
  std::cout << "===============================================" << std::endl;
...
void
DiffusionReactionmine::solve()
{
  std::cout << "===============================================" << std::endl;

  ReductionControl solver_control(/* maxiter = */ 100000,
                                  /* tolerance = */ 1.0e-16,
                                  /* reduce = */ 1.0e-6);
...
void
DiffusionReactionmine::output() const
{
  std::cout << "===============================================" << std::endl;
...
double
DiffusionReactionmine::compute_error(const VectorTools::NormType &norm_type,
