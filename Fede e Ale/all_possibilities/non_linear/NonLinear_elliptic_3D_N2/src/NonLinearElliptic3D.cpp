...
void
NonLinearElliptic3D::assemble_system()
{
          ...
          for (unsigned int i = 0; i < dofs_per_cell; ++i)
            {
              ...
              cell_rhs(i) -= scalar_product(b_loc, solution_gradient_loc[q])
                             * fe_values.shape_value(i,q)
                             * fe_values.JxW(q);
              
              cell_rhs(i) -= sigma_loc * solution_loc[q]
                             * fe_values.shape_value(i,q)
                             * fe_values.JxW(q);
            }
        }
  ...
  // Boundary conditions.
  {
    ...
    //boundary_functions[0] = &dirichlet_function;
    boundary_functions[1] = &dirichlet_function;
    //boundary_functions[2] = &dirichlet_function;
    boundary_functions[3] = &dirichlet_function;
    //boundary_functions[4] = &dirichlet_function;
    boundary_functions[5] = &dirichlet_function;
...
void
NonLinearElliptic3D::solve_system()
{
...
void
NonLinearElliptic3D::solve_newton()
{
  pcout << "===============================================" << std::endl;
...
void
NonLinearElliptic3D::output() const
{
...
double
NonLinearElliptic3D::compute_error(const VectorTools::NormType &norm_type) const
{
