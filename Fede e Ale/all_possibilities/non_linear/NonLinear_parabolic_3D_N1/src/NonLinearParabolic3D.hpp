...
public:
  ...
  public:
          ...
          const unsigned int /*component*/ = 0) const override
    {
      ...
      double u = exp_term * sin_x * sin_y * sin_z;
      ...
      double laplacian_u = -3 * M_PI * M_PI * u;
      
      double squared_gradient = (pow(du_dx, 2) +
                                  pow(du_dy, 2) +
                                  pow(du_dz, 2));
  ...
  public:
          ...
          const unsigned int /*component*/ = 0) const override
    {
      ...
      //return exp(-t) * x * (1 - x) * y * (1 - y) * z * (1 - z);
             ...
             const unsigned int /*component*/ = 0) const override
    {
      ...
      /*
      result[0] = exp(-t) * (1 - 2 * x) * y * (1 - y) * z * (1 - z);
      result[1] = exp(-t) * x * (1 - x) * (1 - 2 * y) * z * (1 - z);
      result[2] = exp(-t) * x * (1 - x) * y * (1 - y) * (1 - 2 * z);
      */
