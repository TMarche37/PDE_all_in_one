#ifndef ELLIPTIC_3D_HPP
#define ELLIPTIC_3D_HPP
...
public:
  ...
  public:
          ...
          const unsigned int /*component*/ = 0) const override
    {
      ...
      return -mu *
         ...
         + b1*exactGrad[0] + b2*exactGrad[1] + b3*exactGrad[2] + sigma*exactValue;
    }
  };
  ...
  // Constructor.
  Elliptic3D(const std::string &mesh_file_name_, const unsigned int &r_)
