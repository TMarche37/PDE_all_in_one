          ...
          for (unsigned int i = 0; i < dofs_per_cell; ++i)
            {
              for (unsigned int j = 0; j < dofs_per_cell; ++j)
                {
                  cell_matrix(i, j) += (
                                               mu_loc
                                               * scalar_product(fe_values[displacement].gradient(j, q), fe_values[displacement].gradient(i, q))
                                               +
                                               lambda_loc
                  ...
                  cell_matrix(i, j) += sigma_loc
                                       * scalar_product(fe_values[displacement].value(i, q), fe_values[displacement].value(j, q))
                                       * fe_values.JxW(q);
              ...
              cell_rhs(i) += scalar_product(f_loc_tensor, fe_values[displacement].value(i, q))
                      * fe_values.JxW(q);
            }
        }
