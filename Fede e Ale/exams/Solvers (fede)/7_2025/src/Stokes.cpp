              ...
              for (unsigned int j = 0; j < dofs_per_cell; ++j)
                {
                  ...
                  cell_matrix(i, j) +=
                    ...
                    fe_values.JxW(q);
                    /*cell_matrix(i,j) +=
                    alpha * scalar_product(fe_values[velocity].value(i, q),
...
*/
  ...
  // Dirichlet boundary conditions.
  {
    ...
    Functions::ZeroFunction<dim> zeroFunction(dim+1);
    ...
    boundary_functions[2] = &zeroFunction;
    boundary_functions[3] = &zeroFunction;
    VectorTools::interpolate_boundary_values(dof_handler,
                                             boundary_functions,
                                             boundary_values,
                                             ComponentMask(
