...
public:
    ...
    class Alpha : public Function<dim>
    {
    public:
        // Constructor.
        Alpha()
        ...
        value(const Point<dim> & /*p*/,
              const unsigned int /*component*/ = 0) const override
        {
          return pow(M_E, -2.0*get_time());
        }
    };

    class Beta : public Function<dim>
    {
    public:
        // Constructor.
        Beta()
        ...
        value(const Point<dim> & /*p*/,
              const unsigned int /*component*/ = 0) const override
        {
          return 2.0*pow(M_E, 2.0 -2.0*get_time());
        }
    };
    ...
    public:
        ...
        value(const Point<dim> &p,
              const unsigned int /*component*/ = 0) const override
        {
          return pow(M_E, 2.0*(p[0]-get_time()));
        ...
        {
          Tensor<1, dim> result;
          result[0] = 2.0*pow(M_E, 2.0*(p[0]-get_time()));
