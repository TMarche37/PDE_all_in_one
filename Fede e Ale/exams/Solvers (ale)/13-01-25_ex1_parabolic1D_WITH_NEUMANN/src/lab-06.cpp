...
main(int argc, char * argv[])
{
  ...
  const std::vector<double> deltat_vector = {dt, dt/2, dt/4, dt/8, dt/16};
            //NOTE: r=2 for better convergence on dt
            //NOTE: theta=1 for better convergence on dt
  time_function(silent, 2, T, 1, N, deltat_vector, mpi_rank);
  ...
  // Same as org
  single_execution(silent, r, T, 1, T/100, 10);
